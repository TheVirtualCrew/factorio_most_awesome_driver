...
data:extend({
  {
    ...
    subgroup = "transport",
    order = "b[personal-transport]-c[passive-car]",
    place_result = "passive-car",
    stack_size = 1
  },
  {
    type = "item-with-entity-data",
    ...
    flags = {"goes-to-quickbar"},
    subgroup = "transport",
    order = "b[personal-transport]-c[requester-car]",
    place_result = "requester-car",
    stack_size = 1
  }
})
...
data:extend({
  {
    ...
    minable = {mining_time = 1, result = "passive-car"},
